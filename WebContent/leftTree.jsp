	...
	<body>
	 <table border="0" class="tree">
      	  ...
      	  <td>
      	  	<table id="list3" border="0" style="display:block">
		      	...
		      	<tr>
		      	  <td>
		      	  	<img src="images/file.gif"/>
		      	  	<a href="addTeacher.jsp" target="mainFrame" id="a6" onclick="xz('6')">添加用户</a>
		      	  </td>	
		      	</tr>
		      	<tr>
		      	  <td>
		      	  	<img src="images/file.gif"/>
		      	  	<a href="resetStuPwd.jsp" target="mainFrame" id="a7" onclick="xz('7')">重置密码 </a>
		      	  </td>	
		      	</tr>
      	  	</table>
      	  </td>
      	  ...
      	  <td>
      	  	<table id="list4" border="0" style="display:block">
		      	<tr>
		      	  <td>
		      	  	<img src="images/file.gif"/>
		      	  	<a href="adminChangePwd.jsp" target="mainFrame" id="a8" onclick="xz('8')">修改密码</a>
		      	  </td>	
		      	</tr>
		      	...
		      	<tr>
		      	  <td>
		      	  	<img src="images/file.gif"/>
		      	  	<a href="TMLAction.action?actionStr=all" target="mainFrame" id="a9" onclick="xz('9')">管理员列表</a>
		      	  </td>
		      	</tr>
		      	<tr>
		      	  <td>
		      	  	<img src="images/file.gif"/>
		      	  	<a href="addManage.jsp" target="mainFrame" id="a10" onclick="xz('10')">添加管理员</a>
		      	  </td>
		      	</tr>		      	
		      	<tr>
		      	  <td>
		      	  	<img src="images/file.gif"/>
		      	  	<a href="resetManagePwd.jsp" target="mainFrame" id="a11" onclick="xz('11')">重置密码</a>
		      	  </td>
		      	</tr>
		      	</s:if>
      	  	</table>
      	...
      	<tr>
      		...
      		<td>
      			<a href="DYAction.action?actionStr=logout" target="_parent" id="a12" onclick="xz('12')">退出系统</a>
      		</td>
      	</tr>
      	</s:if>
      </table>
