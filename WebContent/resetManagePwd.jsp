...
<html>
	...
	<body>
		  ...
		  <th colspan="3" height="40">重置管理员密码</th>
		  <s:form action="RMPwdAction" theme="simple" onsubmit="return checkAddManage()">
		  		<tr>
		  			<td align="right" width="25%">管理员名:</td>
		  			<td width="25">
		  				<s:textfield name="uname" cssClass="input"/>
		  			</td>
		  			<td width="50%"><span id="MsgUname" class="message">输入要重置密码的管理员</span></td>
		  		</tr>
		  		<tr>
